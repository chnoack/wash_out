module WashOut
  ...
  module Dispatcher
    ...
    def _generate_wsdl
      ...
      @service_binding_name = soap_config.service_binding_name
      @service_port_type_name = soap_config.service_port_type_name
      @service_show_soap_action = soap_config.service_show_soap_action
